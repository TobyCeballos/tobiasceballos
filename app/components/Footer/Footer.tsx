...
const products: ProductType[] = [
    {
        id: 1,
        section: "Company",
        link: ['Nosotros', 'Trabaja con nosotros', '¿Como trabajamos?'],
    },
    {
        id: 2,
        section: "Contact",
        link: ['Preguntas frecuentes', 'Afiliados', 'Carreras']
    }
    ,
    {
        id: 3,
        section: "More",
        link: ['Certificados', 'Cedes']
    }
]
            ...
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    <div className="flex flex-shrink-0 items-center border-right">
                        <Image src="/assets/logo/TC.png" alt="logo" width={124} height={124} />
                    </div>
                    <h3 className='text-base font-medium text-paleblue lh-160 mt-5 mb-4 lg:mb-16'>Maximiza todo el potencial <br/>que tiene tu emprendimiento.</h3>
                ...
                {products.map((product) => (
                    <div key={product.id} className="sm:col-span-2">
                        <p className="text-white text-lg font-medium mb-9">{product.section}</p>
                        <ul>
